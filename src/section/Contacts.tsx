...
export default function Contacts() {
    ...
    return(
        <section id="contact" className="min-h-screen flex flex-col items-center justify-center text-center px-6">
            ...
            <a href="https://www.linkedin.com/in/alan-labaš-65323b201" target="_blank" rel="noreferrer" className="ml-2"><FaLinkedin className="text-4xl text-gray-500 hover:text-gray-700 transition-colors mb-4" /></a>
